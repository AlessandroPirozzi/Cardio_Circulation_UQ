...
labels = ['$R_{\mathrm{AR}}^{\mathrm{SYS}}$', '$C_{\mathrm{AR}}^{\mathrm{SYS}}$', '$E_{\mathrm{LV}}^{\mathrm{act}}$',
          ...
          '$t_{\mathrm{LA}}^{\mathrm{del}}$', '$t_{\mathrm{RA}}^{\mathrm{del}}$']
...
fig3.savefig('pareto_8_1000.png')
...
fig4.savefig('pareto_8_2000.png')
