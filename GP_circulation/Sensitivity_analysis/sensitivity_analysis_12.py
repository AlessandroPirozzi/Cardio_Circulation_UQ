...
labels = ['$R_{\mathrm{AR}}^{\mathrm{SYS}}$', '$C_{\mathrm{AR}}^{\mathrm{SYS}}$', '$E_{\mathrm{LV}}^{\mathrm{act}}$',
          '$E_{\mathrm{LV}}^{\mathrm{pass}}$', '$T_{\mathrm{LV}}^{\mathrm{contr}}$', '$T_{\mathrm{LV}}^{\mathrm{rel}}$',
          '$t_{\mathrm{LA}}^{\mathrm{del}}$', '$t_{\mathrm{RA}}^{\mathrm{del}}$','$R_{\mathrm{VEN}}^{\mathrm{SYS}}$',
          '$C_{\mathrm{VEN}}^{\mathrm{SYS}}$', '$R_{\mathrm{VEN}}^{\mathrm{PUL}}$', '$C_{\mathrm{VEN}}^{\mathrm{PUL}}$']
...
fig1.savefig('pareto_12_100.png')
...
fig2.savefig('pareto_12_500.png')
...
fig3.savefig('pareto_12_1000.png')
...
fig4.savefig('pareto_12_2000.png')
...
fig5.savefig('pareto_12_ref.png')
'''
size = 0.25
